...
public class Zadania {
    ...
    /*1. Tworzymy metodę zadanie1, która przyjmie za parametr listę, której elementy są typu Integer, a która wypisze wszystkie elementy listy przy użyciu pętli for-each.
...
13. Napisz metodę, która przyjmie jako argument listę łańcuchów znaków - nazw drużyn. Metoda zwróci listę zbiorów par (obydwa elementy pary to łańcuchy znaków - nazwy drużyn).
Każdy kolejny element listy będzie reprezentował spotkania rozgrywane w kolejce rozgrywek. W jednej kolejce jedna drużyna może zagrać tylko raz, każda drużyna ma zagrać z każdą
inną drużyną raz oraz najlepiej, aby w każdej kolejce było jak najwięcej meczów.
