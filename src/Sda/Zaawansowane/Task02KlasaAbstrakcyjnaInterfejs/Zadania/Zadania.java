package Sda.Zaawansowane.Task02KlasaAbstrakcyjnaInterfejs.Zadania;
...
4. (prod) Stwórz interfejs Product (produkt w sklepie) z metodami:
double getPrice();
double getWeight();
5. (prod) Stwórz klasę ChocolateBar, która będzie reprezentowała batonik. Batonik ma pola cena i waga. Niech batonik będzie produktem (implementuje interfejs Product).
6. (prod) Stwórz klasę Milk, która reprezenetuje mleko. Mleko ma pola: objętość, gęstość, oraz cena za kilogram. Niech mleko także będzie produktem.
7. (geom) Tworzymy klasę Square, która będzie rozszerzała klasę Rectangle.
