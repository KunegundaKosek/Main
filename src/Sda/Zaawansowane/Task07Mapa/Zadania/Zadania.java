...
public class Zadania {
    ...
    /*1. Utwórz i przypisz do zmiennej (capitalByCountry) mapę, która jako klucze i wartości będzie przyjmowała łańcuchy znaków.
...
2. Utwórz mapę, której kluczem będzie imię i nazwisko (łańcuch znaków), a wartością średnia ocen. Wypisz imiona, nazwiska i średnią ocen wszystkich osób w kolejnych wierszach. Następnie wypisz imiona i nazwiska osób, których średnia jest większa niż 3.
3. Tworzymy metodę, która za parametr przyjmie listę stringów, a która zwróci w wyniku mapę, której klucze będą indeksami elementów z listy, a wartościami będą elementy z listy.
4. Tworzymy metodę, która za parametr przyjmie mapę, której klucze oraz wartości to Stringi, a która zwróci mapę, która dla klucza "klucze" będzie przechowywała listę kluczy, a dla klucza "wartosci" będzie przechowywała listę wartości.
