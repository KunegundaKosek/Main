...
public class ClosestFridayToDateCalculator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("findFridayUsingLoop(dateOfToday) = " + findFrindayUsingLoop(dateOfToday));
    ...
    private static LocalDate findFrindayUsingLoop(LocalDate dateOfToday) {
    ...
    private static LocalDate findFridayUsingSwitch(LocalDate dateOfToday) {
        ...
        switch (dayOfWeek) {
            ...
            case SUNDAY:
                ...
                break;
            default:
                System.out.println("It Is Friday I do no need to do nothing");
